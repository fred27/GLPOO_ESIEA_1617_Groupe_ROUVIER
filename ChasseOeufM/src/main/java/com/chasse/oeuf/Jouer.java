...
public class Jouer {
	...
	public static void main(String[] args) {
			...
			try {
				Chocolat c = new Chocolat("C:/Users/Fred/workspace/ChasseOeufM/src/main/java/Oeuf.txt");
				...
				Jardin j = new Jardin("C:/Users/Fred/workspace/ChasseOeufM/src/main/java/Oeuf.txt",r,c,e);
