...
public class JouerGUI extends JFrame{
	...
	private void initialise(){
		...
		try {
			Chocolat ch = new Chocolat("C:/Users/Fred/workspace/ChasseOeufM/src/main/java/Oeuf.txt");
			Rocher r = new Rocher("C:/Users/Fred/workspace/ChasseOeufM/src/main/java/Oeuf.txt");
			Enfant e = new Enfant("C:/Users/Fred/workspace/ChasseOeufM/src/main/java/Enfant.txt");
			Potion p = new Potion("C:/Users/Fred/workspace/ChasseOeufM/src/main/java/Oeuf.txt");
			jardinGUI = new JardinGUI("C:/Users/Fred/workspace/ChasseOeufM/src/main/java/Oeuf.txt",r,ch,e,p);
